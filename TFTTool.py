...
class TFTFile:
    ...
    _fileHeader1 = {
      ...
      "hasCRC":  True,
      "content": {
        "old_lcd_orientation":                  {"struct": "B", "val": 0},
        ...
        "old_lcd_resolution_width":             {"struct": "H", "val": 0},
        "old_lcd_resolution_height":            {"struct": "H", "val": 0},
        "lcd_resolution_x":                     {"struct": "H", "val": 0},
        "lcd_resolution_y":                     {"struct": "H", "val": 0},
        "ui_orientation":                       {"struct": "B", "val": 0},
        "model_series":                         {"struct": "B", "val": 0},
